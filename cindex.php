...
<head>
  ...
  <?php $note ="";
    ...
    if (isset($_POST['withdraw']))
    {
      ...
      makeTransactionCashier('withdraw',$_POST['amount'],$_POST['checkno'],$_POST['user']);
      $note = "<div class='alert alert-success'>successfully transaction done</div>";
    ...
    if (isset($_POST['deposit']))
    {
      ...
      makeTransactionCashier('deposit',$_POST['amount'],$_POST['checkno'],$_POST['user']);
      $note = "<div class='alert alert-success'>successfully transaction done</div>";
           ...
           $row2 = $array3->fetch_assoc();
            ...
            <div class='row'>
                  ...
                  <div class='col'>
                    ...
                    <input type='hidden' value='$row2[id]' name='user' class='form-control ' required>
                    <input type='number' class='form-control my-1' name='checkno' placeholder='Write Check Number' required>
